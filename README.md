...
can generate english and german invoices

example uses
```
./create_invoice.sh -n "Maxi Musti" -s "Barkstreet" -z 50735 -c Köln -i 2026-005 -S "bashs script design" -p "220.00" -l english
```
